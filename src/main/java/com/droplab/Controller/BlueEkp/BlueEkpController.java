...
public class BlueEkpController {
    ...
    public String decodePassword(Model model, @RequestParam(value = "password", required = true) String password) {
        try {
            BlueEkpDecode o = (BlueEkpDecode) Class.forName(getMap().get(0)).newInstance();
    ...
    public String SSRFFileRead(Model model,
        ...
        try {
            BlueEkpSSRF o = (BlueEkpSSRF) Class.forName(getMap().get(1)).newInstance();
            o.setParams(hashMap);
    ...
    public String SSRFXMLDecodeRCE(Model model,
        ...
        try {
            ...
            BlueEkpSSRFXMLDecode aClass =(BlueEkpSSRFXMLDecode)Class.forName(getMap().get(2)).newInstance();
    ...
    private Map<Integer, String> getMap() {
        ...
        hashMap.put(0, "com.droplab.Controller.BlueEkp.Service.BlueEkpDecode");
        hashMap.put(1, "com.droplab.Controller.BlueEkp.Service.BlueEkpSSRF");
        hashMap.put(2, "com.droplab.Controller.BlueEkp.Service.BlueEkpSSRFXMLDecode");
        return hashMap;
    }
}
